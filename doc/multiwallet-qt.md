...
Only requiring some minor changes is deocoin.cpp.
...
Changes to deocoin.cpp
----------------------
deocoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
