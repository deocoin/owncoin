    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Deocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Deocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and deocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Deocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Deocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Deocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Deocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Deocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a deocoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Deocoin Core help message to get a list with possible Deocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Deocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Deocoin network", "", count));
}
...
{
    QString strTitle = tr("Deocoin Core"); // default title
