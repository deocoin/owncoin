    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Deocoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Deocoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  deocoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Deocoin Core is shutting down...") + "<br /><br />" +
