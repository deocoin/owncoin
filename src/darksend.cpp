...
/* *** BEGIN DARKSEND MAGIC - DEOCOIN **********
    Copyright (c) 2014-2015, Deocoin Developers
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Deocoin and make it unusable. To
