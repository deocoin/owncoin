...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Deocoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Deocoin features */
    { "deocoin",               "masternode",             &masternode,             true,      true,       false },
    { "deocoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "deocoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "deocoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "deocoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "deocoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "deocoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "deocoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use deocoind, or the -server option to deocoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> deocoin-cli " + methodname + " " + args + "\n";
}
